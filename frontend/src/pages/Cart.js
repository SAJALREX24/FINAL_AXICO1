  ...
  return (
    <div className="min-h-screen py-8" data-testid="cart-page">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-3xl font-bold text-slate-900 mb-8" data-testid="cart-title">
          Shopping Cart
        </h1>
              ...
              {cart.items.map((item) => (
                ...
                >
                  ...
                  <div className="flex-1">
                    <Link to={`/product/${item.product_id}`}>
                      <h3 className="font-semibold text-lg text-slate-900 hover:text-primary transition-colors mb-2" data-testid="cart-item-name">
                        {item.product?.name}
                      </h3>
                    </Link>
                    
                    <p className="text-slate-600 text-sm mb-4">{item.product?.category}</p>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        ...
                        <span className="font-medium" data-testid="cart-item-quantity">{item.quantity}</span>
                        <button
                          onClick={() => updateQuantity(item.product_id, item.quantity + 1)}
